...
class PhieuNhapXuatTest {
    ...
    void khachHangTest() {
        ...
        // Convert KhachHang to KhachHangEmbedded
        ...
        khachHangEmbedded.setGoiTinh(khachHangBack.getGoiTinh());
        khachHangEmbedded.setDateOfBirth(khachHangBack.getDateOfBirth());
        khachHangEmbedded.setDiaChi(khachHangBack.getDiaChi());
        khachHangEmbedded.setCreatedAt(khachHangBack.getCreatedAt());
        khachHangEmbedded.setCreatedBy(khachHangBack.getCreatedBy());
        khachHangEmbedded.setUpdatedAt(khachHangBack.getUpdatedAt());
        khachHangEmbedded.setUpdatedBy(khachHangBack.getUpdatedBy());
        khachHangEmbedded.setIsDeleted(khachHangBack.getIsDeleted());
