...
public class PhieuNhapXuatResource {
    ...
    public PhieuNhapXuatResource(PhieuNhapXuatService phieuNhapXuatService, PhieuNhapXuatRepository phieuNhapXuatRepository) {
    ...
    /**
     * {@code GET  /phieu-nhap-xuats/:id} : get the "id" phieuNhapXuat.
     *
