...
public class DanhMucHangService {
    ...
    public DanhMucHangService(DanhMucHangRepository danhMucHangRepository, DanhMucHangMapper danhMucHangMapper, DataSynchronizationService dataSynchronizationService) {
    ...
    public Optional<DanhMucHangDTO> partialUpdate(DanhMucHangDTO danhMucHangDTO) {
        ...
        return danhMucHangRepository
            ...
            .map(danhMucHang -> {
                DanhMucHang savedDanhMucHang = danhMucHangRepository.save(danhMucHang);
                
                // Synchronize embedded documents
                dataSynchronizationService.updateEmbeddedDanhMucHang(savedDanhMucHang);
                
                return savedDanhMucHang;
            })
