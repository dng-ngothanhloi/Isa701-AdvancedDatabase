...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MASTERDATA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MASTERDATA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MASTERDATA actions', async () => {
      const arg = { id: 'dcca74b5-7a84-4c1f-a3d1-1b7365038d78' };
    ...
    it('dispatches UPDATE_MASTERDATA actions', async () => {
      const arg = { id: 'dcca74b5-7a84-4c1f-a3d1-1b7365038d78' };
    ...
    it('dispatches PARTIAL_UPDATE_MASTERDATA actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_MASTERDATA actions', async () => {
      const arg = 42666;
