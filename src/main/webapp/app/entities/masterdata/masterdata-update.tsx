    ...
    return (
        <div>
            <Row className="justify-content-center">
                <Col md="8">
                    <h2 id="warehousMmgmtApp.masterdata.home.createOrEditLabel" data-cy="MasterdataCreateUpdateHeading">
                        <Translate contentKey="warehousMmgmtApp.masterdata.home.createOrEditLabel">Create or edit a
                ...
                <Col md="8">
                    {loading ? (
                        ...
                        <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
                            ...
                            <ValidatedField
                                label={translate('warehousMmgmtApp.masterdata.category')}
                                ...
                                validate={{
                                    ...
                                    maxLength: {
                                        value: 20,
                                        message: translate('entity.validation.maxlength', {max: 20})
                                    },
                                }}
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.masterdata.dataKey')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.masterdata.dataValue')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.masterdata.isDeleted')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.masterdata.createdAt')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.masterdata.createdBy')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.masterdata.updatedAt')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.masterdata.updatedBy')}
                            ...
                            />
                            <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/masterdata"
                                    replace color="info">
