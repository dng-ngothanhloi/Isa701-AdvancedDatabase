...
export const MasterdataDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="warehouseMgmApp.masterdata.delete.question">
        <Translate contentKey="warehouseMgmApp.masterdata.delete.question" interpolate={{ id: masterdataEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-masterdata" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
