...
import reducer, {
    ...
    reset,
    updateEntity,
} from './chi-tiet-nhap-xuat.reducer';
...
describe('Entities reducer tests', () => {
    ...
    describe('Actions', () => {
        ...
        it('dispatches FETCH_CHITIETNHAPXUAT_LIST actions', async () => {
            const arg = {};
        ...
        it('dispatches FETCH_CHITIETNHAPXUAT actions', async () => {
            const arg = 42666;
        ...
        it('dispatches CREATE_CHITIETNHAPXUAT actions', async () => {
            const arg = {id: '5a277c4b-4bdc-49cf-9239-fcf0d97e191e'};
        ...
        it('dispatches UPDATE_CHITIETNHAPXUAT actions', async () => {
            const arg = {id: '5a277c4b-4bdc-49cf-9239-fcf0d97e191e'};
        ...
        it('dispatches PARTIAL_UPDATE_CHITIETNHAPXUAT actions', async () => {
            const arg = {id: 'ABC'};
        ...
        it('dispatches DELETE_CHITIETNHAPXUAT actions', async () => {
            const arg = 42666;
