    ...
    <Row>
      <Col md="8">
        <h2 data-cy="chiTietNhapXuatDetailsHeading">
          <Translate contentKey="warehouseMgmApp.chiTietNhapXuat.detail.title">ChiTietNhapXuat</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="createdAt">
              <Translate contentKey="warehouseMgmApp.chiTietNhapXuat.createdAt">Created At</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="createdBy">
              <Translate contentKey="warehouseMgmApp.chiTietNhapXuat.createdBy">Created By</Translate>
            </span>
          </dt>
          <dd>{chiTietNhapXuatEntity.createdBy}</dd>
          <dt>
            <span id="updatedAt">
              <Translate contentKey="warehouseMgmApp.chiTietNhapXuat.updatedAt">Updated At</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="updatedBy">
              <Translate contentKey="warehouseMgmApp.chiTietNhapXuat.updatedBy">Updated By</Translate>
            </span>
          </dt>
          <dd>{chiTietNhapXuatEntity.updatedBy}</dd>
          <dt>
            <span id="isDeleted">
              <Translate contentKey="warehouseMgmApp.chiTietNhapXuat.isDeleted">Is Deleted</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="warehouseMgmApp.chiTietNhapXuat.maHang">Ma Hang</Translate>
          </dt>
