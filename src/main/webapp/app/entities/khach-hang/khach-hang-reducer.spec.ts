...
describe('Entities reducer tests', () => {
    ...
    describe('Actions', () => {
        ...
        it('dispatches FETCH_KHACHHANG_LIST actions', async () => {
            const arg = {};
        ...
        it('dispatches FETCH_KHACHHANG actions', async () => {
            const arg = 42666;
        ...
        it('dispatches CREATE_KHACHHANG actions', async () => {
            const arg = {id: '41365e50-2549-4d74-808e-5a9fecfd51ce'};
        ...
        it('dispatches UPDATE_KHACHHANG actions', async () => {
            const arg = {id: '41365e50-2549-4d74-808e-5a9fecfd51ce'};
        ...
        it('dispatches PARTIAL_UPDATE_KHACHHANG actions', async () => {
            const arg = {id: 'ABC'};
        ...
        it('dispatches DELETE_KHACHHANG actions', async () => {
            const arg = 42666;
