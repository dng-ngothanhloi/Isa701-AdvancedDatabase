  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="warehouseMgmApp.khachHang.home.createOrEditLabel" data-cy="KhachHangCreateUpdateHeading">
            <Translate contentKey="warehouseMgmApp.khachHang.home.createOrEditLabel">Create or edit a KhachHang</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('warehouseMgmApp.khachHang.maKH')}
                id="khach-hang-maKH"
                name="maKH"
                data-cy="maKH"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('warehouseMgmApp.khachHang.tenKH')}
                id="khach-hang-tenKH"
                name="tenKH"
                data-cy="tenKH"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('warehouseMgmApp.khachHang.goiTinh')}
              ...
              >
                {empSexValues.map(empSex => (
                  <option value={empSex} key={empSex}>
                    {translate(`warehouseMgmApp.EmpSex.${empSex}`)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('warehouseMgmApp.khachHang.dateOfBirth')}
              ...
              />
              <ValidatedField
                label={translate('warehouseMgmApp.khachHang.diaChi')}
              ...
              />
              <ValidatedField
                label={translate('warehouseMgmApp.khachHang.createdAt')}
              ...
              />
              <ValidatedField
                label={translate('warehouseMgmApp.khachHang.createdBy')}
              ...
              />
              <ValidatedField
                label={translate('warehouseMgmApp.khachHang.updatedAt')}
              ...
              />
              <ValidatedField
                label={translate('warehouseMgmApp.khachHang.updatedBy')}
              ...
              />
              <ValidatedField
                label={translate('warehouseMgmApp.khachHang.isDeleted')}
                ...
                type="checkbox"
              />
              <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/khach-hang" replace color="info">
