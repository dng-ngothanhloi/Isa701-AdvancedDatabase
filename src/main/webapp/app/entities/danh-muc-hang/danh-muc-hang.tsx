  ...
  return (
    <div>
      <h2 id="danh-muc-hang-heading" data-cy="DanhMucHangHeading">
        <Translate contentKey="warehouseMgmApp.danhMucHang.home.title">Danh Muc Hangs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="warehouseMgmApp.danhMucHang.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/danh-muc-hang/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="warehouseMgmApp.danhMucHang.home.createLabel">Create new Danh Muc Hang</Translate>
          </Link>
        </div>
      </h2>
        ...
        {danhMucHangList && danhMucHangList.length > 0 ? (
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {danhMucHang.ngaySanXuat ? (
                      <TextFormat type="date" value={danhMucHang.ngaySanXuat} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>
                    {danhMucHang.hanSuDung ? <TextFormat type="date" value={danhMucHang.hanSuDung} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>

                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`/danh-muc-hang/${danhMucHang.id}`} color="info" size="sm" data-cy="entityDetailsButton">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="warehouseMgmApp.danhMucHang.home.notFound">No Danh Muc Hangs found</Translate>
            </div>
          )
        )}
      </div>
