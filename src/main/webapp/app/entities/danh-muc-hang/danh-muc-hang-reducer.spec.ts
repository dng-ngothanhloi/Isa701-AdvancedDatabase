...
describe('Entities reducer tests', () => {
    ...
    describe('Actions', () => {
        ...
        it('dispatches FETCH_DANHMUCHANG_LIST actions', async () => {
            const arg = {};
        ...
        it('dispatches FETCH_DANHMUCHANG actions', async () => {
            const arg = 42666;
        ...
        it('dispatches CREATE_DANHMUCHANG actions', async () => {
            const arg = {id: 'b4366fac-795a-442f-b748-535aff0bfaef'};
        ...
        it('dispatches UPDATE_DANHMUCHANG actions', async () => {
            const arg = {id: 'b4366fac-795a-442f-b748-535aff0bfaef'};
        ...
        it('dispatches PARTIAL_UPDATE_DANHMUCHANG actions', async () => {
            const arg = {id: 'ABC'};
        ...
        it('dispatches DELETE_DANHMUCHANG actions', async () => {
            const arg = 42666;
