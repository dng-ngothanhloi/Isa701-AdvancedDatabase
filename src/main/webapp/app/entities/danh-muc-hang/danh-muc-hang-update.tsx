    ...
    return (
        <div>
            <Row className="justify-content-center">
                <Col md="8">
                    <h2 id="warehousMmgmtApp.danhMucHang.home.createOrEditLabel"
                        data-cy="DanhMucHangCreateUpdateHeading">
                        <Translate contentKey="warehousMmgmtApp.danhMucHang.home.createOrEditLabel">Create or edit a
                            DanhMucHang</Translate>
                    </h2>
                </Col>
            </Row>
            <Row className="justify-content-center">
                <Col md="8">
                    {loading ? (
                        ...
                        <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
                            ...
                            <ValidatedField
                                label={translate('warehousMmgmtApp.danhMucHang.maHang')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.danhMucHang.tenHang')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.danhMucHang.donVitinh')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.danhMucHang.noiSanXuat')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.danhMucHang.ngaySanXuat')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.danhMucHang.hanSuDung')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.danhMucHang.createdAt')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.danhMucHang.createdBy')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.danhMucHang.updatedAt')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.danhMucHang.updatedBy')}
                            ...
                            />
                            <ValidatedField
                                label={translate('warehousMmgmtApp.danhMucHang.isDeleted')}
                                ...
                                type="checkbox"
                            />
                            <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to="/danh-muc-hang"
                                    replace color="info">
