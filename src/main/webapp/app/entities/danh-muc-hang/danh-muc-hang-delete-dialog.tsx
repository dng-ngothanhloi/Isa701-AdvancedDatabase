...
export const DanhMucHangDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="warehouseMgmApp.danhMucHang.delete.question">
        <Translate contentKey="warehouseMgmApp.danhMucHang.delete.question" interpolate={{ id: danhMucHangEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-danhMucHang" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
