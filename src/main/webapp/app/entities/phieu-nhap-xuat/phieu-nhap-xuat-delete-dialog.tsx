...
export const PhieuNhapXuatDeleteDialog = () => {
    ...
    return (
        <Modal isOpen toggle={handleClose}>
            ...
            <ModalBody id="warehousMmgmtApp.phieuNhapXuat.delete.question">
                <Translate contentKey="warehousMmgmtApp.phieuNhapXuat.delete.question"
                           interpolate={{id: phieuNhapXuatEntity.id}}>
            ...
            <ModalFooter>
                ...
                <Button id="jhi-confirm-delete-phieuNhapXuat" data-cy="entityConfirmDeleteButton" color="danger"
