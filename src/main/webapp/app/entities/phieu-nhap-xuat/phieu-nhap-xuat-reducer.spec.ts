...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHIEUNHAPXUAT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PHIEUNHAPXUAT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PHIEUNHAPXUAT actions', async () => {
      const arg = { id: '00fd77ef-aaa1-456d-8790-f6bcb50eb294' };
    ...
    it('dispatches UPDATE_PHIEUNHAPXUAT actions', async () => {
      const arg = { id: '00fd77ef-aaa1-456d-8790-f6bcb50eb294' };
    ...
    it('dispatches PARTIAL_UPDATE_PHIEUNHAPXUAT actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_PHIEUNHAPXUAT actions', async () => {
      const arg = 42666;
