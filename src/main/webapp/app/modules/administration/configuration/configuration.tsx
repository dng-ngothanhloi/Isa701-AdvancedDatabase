                                ...
                                <td>
                                    {Object.keys(property.properties).map((propKey, index) => (
                                        <Row key={index}>
                                            ...
                                            <Col md="8">
                                                <Badge
                                                    className="float-end bg-secondary break">{JSON.stringify(property.properties[propKey])}</Badge>
                                            </Col>
                                        </Row>
                                    ))}
                                </td>
                            ...
                            {Object.keys(envKey.properties)
                                ...
                                .map((propKey, propIndex) => (
                                    <tr key={propIndex}>
                                        ...
                                        <td className="break">
                                            <span
                                                className="float-end badge bg-secondary break">{envKey.properties[propKey].value}</span>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
